...
import { Calendar, ShoppingBag, Megaphone, FileText, Users, Receipt } from "lucide-react";
...
const SECTIONS = [
  ...
  { to: "/admin/orders" as const, label: "Orders", icon: Receipt, description: "All orders from registered users" },
];
